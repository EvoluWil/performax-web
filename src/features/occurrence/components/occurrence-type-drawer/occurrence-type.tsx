...
import { useOccurrenceTypeDrawer } from './occurrence-type.hook';

export type OccurrenceTypeDrawerProps = {
  open: boolean;
  onClose: () => void;
...
export const OccurrenceTypeDrawer: React.FC<OccurrenceTypeDrawerProps> = (
  ...
  const { control, handleOccurrenceType, loading, handleClose, open, editing } =
    useOccurrenceTypeDrawer(props);
